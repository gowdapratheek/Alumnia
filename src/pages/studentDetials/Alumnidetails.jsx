...
function Alumnidetails() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-[#edf3f1] shadow-md rounded-md">
      <Link
        to="/alumni"
      ...
      <h2 className="text-2xl font-bold mb-6 text-[#008E50]">Alumni Details</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-4 rounded-md shadow-md">
          ...
          <p className="mt-1 text-[#202020]">{alumniDetails.contact.github}</p>
        </div>
        <div className="bg-white p-4 rounded-md shadow-md">
          <label className="block text-sm font-medium text-[#008E50]">
            LinkedIn:
